...
from fetch_data import df_APPL_new, df_TSLA_new, df_MSFT_new, df_NVDA_new


df_APPL_old = pd.read_csv('../Version 2/data/clean_AAPL_stock_data.csv')
df_TSLA_old = pd.read_csv('../Version 2/data/clean_TSLA_stock_data.csv')
df_MSFT_old = pd.read_csv('../Version 2/data/clean_MSFT_stock_data.csv')
df_NVDA_old = pd.read_csv('../Version 2/data/clean_NVDA_stock_data.csv')
